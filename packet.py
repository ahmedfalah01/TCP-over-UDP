...
class Packet:
    # keep track of the IDs of Unacked packets
    ...
    def get_type(self):
        if self.p_type == 0x0:
            ...
            return 'FIN-ACK'
    # check what to send back ACK or FIN_ACK
    ...
    # return the binary representation of the packet (packet -> binary)
    ...
    def to_bytes(self):
        ...
        head_binary = type_binary + id_binary + seq_binary + len_binary + checksum_binary
        ...
        return packet
    # generating unique id for packet
